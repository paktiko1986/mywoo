...
function ProductDetailsSectionDescriptionBlockEdit({ attributes, clientId, context: { selectedTab }, }) {
    ...
    function menuItemClickHandler(productTemplate, onClose) {
        return async function handleMenuItemClick() {
            try {
                ...
                const productMetaData = productTemplate.productData.meta_data ?? [];
    ...
    function getMenuItem(onClose) {
        return function renderMenuItem(productTemplate) {
            const isSelected = selectedProductTemplate?.id === productTemplate.id;
            return ((0, element_1.createElement)(components_1.MenuItem, { key: productTemplate.id, info: productTemplate.description ?? undefined, isSelected: isSelected, icon: isSelected
                    ? resolveIcon('check')
                    : resolveIcon(productTemplate.icon, productTemplate.title), iconPosition: "left", role: "menuitemradio", onClick: menuItemClickHandler(productTemplate, onClose), className: (0, clsx_1.default)({
    ...
    async function handleModalChangeClick() {
        try {
            ...
            const product = (await saveEditedEntityRecord('postType', 'product', productId, {
                throwOnError: true,
            })) ?? { id: productId };
    ...
    return ((0, element_1.createElement)(block_slot_fill_1.BlockFill, { name: "section-description", slotContainerBlockName: "woocommerce/product-section" },
        (0, element_1.createElement)("div", { ...blockProps },
            ...
            (0, i18n_1.__)('This is a <ProductTemplate />.', 'woocommerce'), {
                ProductTemplate: ((0, element_1.createElement)("span", null, selectedProductTemplate?.title?.toLowerCase())),
            })),
