...
function NameBlockEdit({ attributes, clientId, }) {
    ...
    return ((0, element_1.createElement)(element_1.Fragment, null,
        (0, element_1.createElement)("div", { ...blockProps },
            (0, element_1.createElement)(components_1.BaseControl, { id: nameControlId, label: (0, element_1.createElement)(label_1.Label, { label: (0, i18n_1.__)('Name', 'woocommerce'), required: true }), className: (0, clsx_1.default)({
