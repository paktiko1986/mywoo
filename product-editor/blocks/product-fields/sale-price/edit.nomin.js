...
function Edit({ attributes, clientId, context, }) {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(components_1.BaseControl, { id: salePriceId, help: salePriceValidationError ? salePriceValidationError : help, className: (0, clsx_1.default)({
