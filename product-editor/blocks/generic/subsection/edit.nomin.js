...
function SubsectionBlockEdit({ attributes, }) {
    ...
    const innerBlockProps = (0, block_editor_1.useInnerBlocksProps)({
        className: (0, clsx_1.default)('wp-block-woocommerce-product-section-header__content', `wp-block-woocommerce-product-section-header__content--block-gap-${blockGap}`),
    }, { templateLock: 'all' });
