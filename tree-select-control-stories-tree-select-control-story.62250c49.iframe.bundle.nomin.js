...
var _Options = function Options(_ref) {
  ...
  return options.map(function (option) {
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(component/* default */.A, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(_Options, {
...
/* harmony default export */ const tree_select_control_options = (_Options);
...
var _TreeSelectControl = function TreeSelectControl(_ref) {
  var id = _ref.id,
    label = _ref.label,
  ...
  var instanceId = (0,use_instance_id/* default */.A)(_TreeSelectControl);
  ...
  var filteredOptions = (0,react.useMemo)(function () {
    ...
    var _reduceOptions = function reduceOptions(acc, _ref2) {
      var _ref2$children = _ref2.children,
        children = _ref2$children === void 0 ? [] : _ref2$children,
        option = (0,objectWithoutProperties/* default */.A)(_ref2, tree_select_control_excluded);
      if (children.length) {
        option.children = children.reduce(_reduceOptions, []);
      }
      if (isSearching) {
    ...
    var filteredTreeOptions = treeOptions.reduce(_reduceOptions, []);
...
/* harmony default export */ const tree_select_control = (_TreeSelectControl);
;// ../../packages/js/components/src/tree-select-control/stories/tree-select-control.story.js
