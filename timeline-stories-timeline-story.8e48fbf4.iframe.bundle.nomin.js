...
var TimelineItem = function TimelineItem(_ref) {
  ...
  var itemClassName = (0,clsx/* default */.A)('woocommerce-timeline-item', className);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: (item.body || []).map(function (bodyItem, index) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          children: bodyItem
        }, "timeline-item-body-".concat(index));
      })
    })]
  });
};
...
var TimelineGroup = function TimelineGroup(_ref) {
  var _ref$group = _ref.group,
    ...
    clockFormat = _ref.clockFormat;
  var groupClassName = (0,clsx/* default */.A)('woocommerce-timeline-group', className);
...
var Timeline = function Timeline(_ref) {
  ...
  var timelineClassName = (0,clsx/* default */.A)('woocommerce-timeline', className);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("ul", {
      children: items.reduce(groupItemsUsing(groupBy), []).map(addGroupTitles).sort(sortByDateUsing(orderBy)).map(function (group) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)(timeline_group, {
          group: group,
          orderBy: orderBy,
          clockFormat: clockFormat
