...
import withProductReviewTemplateEdit from './edit';

function registerProductReviewTemplateNamespace(
	props: Block,
	blockName: string
) {
...
addFilter(
	...
	registerProductReviewTemplateNamespace
);

const registerProductReviewTemplateVariation = () => {
...
addFilter(
	'editor.BlockEdit',
	'woocommerce/with-product-review-template-edit',
	withProductReviewTemplateEdit
);

export { registerProductReviewTemplateVariation };
